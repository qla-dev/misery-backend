...
const copy = {
  bs: {
    nav: ['Igra', 'Misery Lane', 'Karte', 'Preuzmi'], buy: 'Preuzmi', eyebrow: 'PARTY IGRA · 2–5 IGRAČA',
  ...
  en: {
    nav: ['Game', 'Misery Lane', 'Cards', 'Download'], buy: 'Download', eyebrow: 'PARTY GAME · 2–5 PLAYERS',
...
const faqs = [
  ['Koliko igrača može igrati?', 'Od 2 do 5 igrača. Solo mod u aplikaciji koristi tri života.'],
