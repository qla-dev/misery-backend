...
@if($canEnhanceArtwork)<form method="post" action="{{ route('cms.cards.enhance-artwork',$card) }}" style="margin-top:10px">@csrf<button class="secondary" type="submit" style="width:100%">Enhance current artwork</button><p class="hint" style="margin:8px 0 0">Smooths crop pixelation, restores crisp edges, and keeps the optimized JPEG below 100 KB.</p></form>@endif</section>
