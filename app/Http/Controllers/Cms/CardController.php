...
class CardController extends Controller
{
    ...
    public function generate(Request $request, Card $card)
    {
        ...
        $prompt = implode("\n", [
            ...
            'Mandatory safe zone: keep every person, head, hand, foot, limb, prop, hazard, object, support, and meaningful environmental element completely inside the canvas with at least 8% clear black padding from all four edges.',
    ...
    private function generateWithGemini(string $prompt, array $logContext): array
    {
        ...
        $parts = [
            ...
            ['text' => 'The next JPEG is the primary composition reference. Follow only its scale, hierarchy, grounding, frame coverage, dimensional construction, and spatial balance. Choose a different three-quarter or isometric camera angle. Do not copy its digits, timer, warning icon, appliance, laundry, exact viewpoint, literal content, hands-on-head pose, or one-person cast.'],
            ['inlineData' => [
                'mimeType' => 'image/jpeg',
