...
class CardController extends Controller
{
    ...
    public function generate(Request $request, Card $card)
    {
        ...
        $prompt = implode("\n", [
            ...
            'Mandatory foreground safe zone: keep every person, head, hand, foot, limb, prop, hazard, vehicle, furniture item, effect, and event object completely inside the canvas with at least 12% clear pure-black padding from all four edges.',
