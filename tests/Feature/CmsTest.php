...
class CmsTest extends TestCase
{
    ...
    public function test_generate_action_saves_black_background_jpeg_path_on_card(): void
    {
        ...
        Http::assertSent(function ($request) {
            ...
            && str_contains($request['prompt'], 'noticeably zoomed-out wide view')
            && str_contains($request['prompt'], 'complete visibility is more important than making subjects large')
            && str_contains($request['prompt'], 'at least 12% clear pure-black padding from all four edges')
            ...
            && str_contains($request['prompt'], 'Only the uniform black background may touch all four canvas edges')
